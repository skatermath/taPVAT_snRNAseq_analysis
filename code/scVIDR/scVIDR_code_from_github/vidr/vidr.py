    ...
    **model_kwargs
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        dose_loss = (
            np.log1p(
                self.registry_["field_registries"]["batch"]["state_registry"][
                    "categorical_mapping"
                ].astype(float)
            )
            if dose_loss
    ...
    @classmethod
    def setup_anndata(cls, adata: AnnData, batch_key: str | None = None, labels_key: str | None = None, layer: str | None = None, **kwargs):
    ...
    def predict(
        ...
        cell_type_key = self.registry_["field_registries"]["labels"]["state_registry"][
            "original_key"
        ]
        treatment_key = self.registry_["field_registries"]["batch"]["state_registry"][
            "original_key"
        ]
    ...
    def reg_mean_plot(
        ...
        **kwargs,
        ...
        condition_key = self.registry_["field_registries"]["batch"]["state_registry"][
            "original_key"
        ]
